...
################################
# Func. ScrapyOL: Scrapea/Recolecta la informacion de la pagina principal de Ofertas Laborales
################################
def ScrapyOL():
    class Oferta(Item):
        id = Field()
...
################################
# Func. ScrapyOLInicial: Scrapea/Recolecta solo el titulo de la ultima Oferta Laboral
################################
def ScrapyOLInicial():
    class Oferta(Item):
        id = Field()
