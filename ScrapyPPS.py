...
################################
# Func. ScrapyPPS: Scrapea/Recolecta la informacion de la pagina principal de PPS
################################
def ScrapyPPS():
    class Pasantia(Item):
        id = Field()
...
################################
# Func. ScrapyPPSInicial: Scrapea/Recolecta solo el titulo de la ultima PPS publicada
################################
def ScrapyPPSInicial():
